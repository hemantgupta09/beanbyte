...
// Class definition
var PB_OT_miscellaneous = function () {
  ...
  const cardsTarget = function (element, event) {
    ...
    const _process_a = (data) => {
      ...
      switch (event.value) {
        ...
        case pb.opr.transactions.miscellaneous.a:
          return _process_a_inner_fun_a(element, event);

        case pb.opr.transactions.miscellaneous.b:
  ...
  const actionsTarget = function (element, _event) {
    ...
    switch (_event.value) {
      ...
      case pb.opr.transactions.miscellaneous:
