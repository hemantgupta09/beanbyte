...
var PB_OT_purchases = function () {
  ...
  const pageOpen = () => {
    ...
    //    xResponse = dummy_ajax_transactions_opr.purchases([pb.opr.transactions.purchases.n, 'page']);
    return ajax;
  }
  ...
  function loadsTarget(element, button) {
    ...
    const getLoad = function (form, button, values) {
      ...
      //      xResponse = dummy_ajax_transactions_opr.purchases([button.value, button.getAttribute('name')], values)
  ...
  function tablesTarget(element, button) {
    const getTable = (button, params, htLen) => {
      ...
      //      xResponse = dummy_ajax_transactions_opr.purchases([button.value, button.getAttribute('name')], params)
