...
var PB_OT_sales = function () {
  ...
  const pageOpen = () => {
    ...
    //    xResponse = dummy_ajax_transactions_opr.sales([pb.opr.transactions.sales.n, 'page']);
    return ajax;
  }
  ...
  function createsTarget(element, event) {
    ...
    return ajax;
    //      xResponse = dummy_ajax_transactions_opr.sales([event.value, event.type], [])
  ...
  function loadsTarget(element, button) {
    ...
    const getLoad = function (form, button, values) {
      ...
      //      xResponse = dummy_ajax_transactions_opr.sales([button.value, button.getAttribute('name')], values)
