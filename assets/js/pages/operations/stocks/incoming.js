  ...
  const actionsTarget = function (element, event) {
    ...
    const action_save = (element, event) => {
      ...
      sleep(100).then(() => {
        ...
        PB_extend_reset.$_form(formEle, 'call');
