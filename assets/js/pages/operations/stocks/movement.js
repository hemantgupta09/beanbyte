...
var PB_OS_movement = function () {
  ...
  function tablesTarget(element, button) {
    const getTable = (button, params, htLen) => {
      ...
      const _process_a = (data) => {
        if (data !== false) {
          const OPTION = [4, ['view', 'edit', 'delete'], ['view-movement', 'edit-movement', 'delete-movement']];
          let tableProfile = {
            0: {
              type  : TBL_ct.cb,
              method: 'a',
