...
var PB_TG_sales = function () {
  ...
  const pageOpen = () => {
    ...
    const _process_a = (data) => {
      $table = new tablesProfile_taxation(thePathArr);
  ...
  const report_sale_detailed = function (element, event) {
  ...
  const report_sale_invoice = function (element, event) {
  ...
  const report_sale_item = function (element, event) {
  ...
  const report_sale_party = function (element, event) {
  ...
  const tab_sale_detailed = function (element, data) {
  ...
  const tab_sale_invoice = function (element, data, event) {
  ...
  const tab_sale_item = function (element, data, event) {
  ...
  const tab_sale_party = function (element, data, event) {
  ...
  const tabsTarget = function (element, event) {
    ...
    const _process_a = (data) => {
      console.log(data);
      switch (event.value) {
        case pb.tax.gstreport.sales.p.detailed:
          return tab_sale_detailed(element, data, event);
        case pb.tax.gstreport.sales.p.invoice:
          return tab_sale_invoice(element, data, event);
        case pb.tax.gstreport.sales.p.item:
          return tab_sale_item(element, data, event);
        case pb.tax.gstreport.sales.p.party:
          return tab_sale_party(element, data, event);
      }
    }
    const ajax = new AjaxPB();
    const urlID = ajax.buildingURL(thePathArr, {
  ...
  const reportsTarget = function (element, event) {
    switch (event.value) {
      case pb.tax.gstreport.sales.p.detailed:
        return report_sale_detailed(element, event);
      case pb.tax.gstreport.sales.p.invoice:
        return report_sale_invoice(element, event);
      case pb.tax.gstreport.sales.p.item:
        return report_sale_item(element, event);
      case pb.tax.gstreport.sales.p.party:
        return report_sale_party(element, event);
