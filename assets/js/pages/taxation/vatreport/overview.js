...
var PB_TV_overview = function () {
  ...
  const cardsTarget = function (element, event) {
    ...
    const _process_a = (data) => {
      ...
      switch (event.value) {
        ...
        case pb.tax.vatreport.overview.a:
          return _process_a_inner_fun_a(element, event);

        case pb.tax.vatreport.overview.b:
  ...
  const actionsTarget = function (element, _event) {
    ...
    switch (_event.value) {
      ...
      case pb.tax.vatreport.overview:
