...
var PB_TS_incometax = function () {
  ...
  const cardsTarget = function (element, event) {
    ...
    const _process_a = (data) => {
      ...
      switch (event.value) {
        ...
        case pb.tax.standard.incometax.a:
          return _process_a_inner_fun_a(element, event);

        case pb.tax.standard.incometax.b:
  ...
  const actionsTarget = function (element, _event) {
    ...
    switch (_event.value) {
      ...
      case pb.tax.standard.incometax:
