...
var PB_SS_detail = function () {
  ...
  const cardsTarget = function (element, event) {
    ...
    const _process_a = (data) => {
      ...
      switch (event.value) {
        ...
        case pb.set.subscriptions.detail.a:
          return _process_a_inner_fun_a(element, event);

        case pb.set.subscriptions.detail.b:
  ...
  const actionsTarget = function (element, _event) {
    ...
    switch (_event.value) {
      ...
      case pb.set.subscriptions.detail:
