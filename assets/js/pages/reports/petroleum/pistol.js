...
var PB_RP_pistol = function () {
  ...
  const tab_pistol_item = function (element, data) {
  ...
  const tab_pistol_combined = function (element, data, event) {
    ...
    const _process_a = (data) => {
      ...
      switch (event.value) {
        case pb.rpt.petroleum.pistol.p.item:
          return tab_pistol_item(element, data, event);

        case pb.rpt.petroleum.pistol.p.combined:
          return tab_pistol_combined(element, data, event);
