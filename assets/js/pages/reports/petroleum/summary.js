...
var PB_RP_summary = function () {
  ...
  const report_summary_quick = function (element, event) {
  ...
  const report_summary_standard = function (element, event) {
  ...
  const report_summary_advance = function (element, event) {
  ...
  const tab_summary_quick = function (element, data) {
  ...
  const tab_summary_standard = function (element, data, event) {
  ...
  const tab_summary_advance = function (element, data, event) {
    ...
    const _process_a = (data) => {
      ...
      switch (event.value) {
        case pb.rpt.petroleum.summary.p.quick:
          return tab_summary_quick(element, data, event);
        case pb.rpt.petroleum.summary.p.standard:
          return tab_summary_standard(element, data, event);
        case pb.rpt.petroleum.summary.p.advance:
          return tab_summary_advance(element, data, event);
      }
    }
    const ajax = new AjaxPB();
    const urlID = ajax.buildingURL(thePathArr, {
  ...
  const reportsTarget = function (element, event) {
    switch (event.value) {
      case pb.rpt.petroleum.summary.p.quick:
        return report_summary_quick(element, event);
      case pb.rpt.petroleum.summary.p.standard:
        return report_summary_standard(element, event);
      case pb.rpt.petroleum.summary.p.advance:
        return report_summary_advance(element, event);
