...
var PB_RP_sales = function () {
  ...
  const report_sale_category = function (element, event) {
  ...
  const report_sale_customer = function (element, event) {
  ...
  const report_sale_advance = function (element, event) {
  ...
  const tab_sale_category = function (element, data, event) {
  ...
  const tab_sale_customer = function (element, data, event) {
  ...
  const tab_sale_advance = function (element, data, event) {
  ...
  const reportsTarget = function (element, event) {
    switch (event.value) {
      case pb.rpt.products.sales.p.category:
        return report_sale_category(element, event);
      case pb.rpt.products.sales.p.item:
        return report_sale_item(element, event);
      case pb.rpt.products.sales.p.customer:
        return report_sale_customer(element, event);
      case pb.rpt.products.sales.p.advance:
        return report_sale_advance(element, event);
