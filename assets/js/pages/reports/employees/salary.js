...
var PB_RE_salary = function () {
  ...
  const report_salary_payroll = function (element, event) {
  ...
  const report_salary_ledger = function (element, event) {
    // form for parameters
    console.log(event);
  ...
  const report_salary_slip = function (element, event) {
  ...
  const tab_salary_payroll = function (element, data, event) {
  ...
  const tab_salary_ledger = function (element, data, event) {
  ...
  const tab_salary_slip = function (element, data, event) {
    ...
    const _process_a = (data) => {
      ...
      switch (event.value) {
        case pb.rpt.employees.salary.p.payroll:
          return tab_salary_payroll(element, data, event);
        case pb.rpt.employees.salary.p.ledger:
          return tab_salary_ledger(element, data, event);
        case pb.rpt.employees.salary.p.slip:
          return tab_salary_slip(element, data, event);
      }
    }
    const ajax = new AjaxPB();
    const urlID = ajax.buildingURL(thePathArr, {
  ...
  const reportsTarget = function (element, event) {
    switch (event.value) {
      case pb.rpt.employees.salary.p.payroll:
        return report_salary_payroll(element, event);
      case pb.rpt.employees.salary.p.ledger:
        return report_salary_ledger(element, event);
      case pb.rpt.employees.salary.p.slip:
        return report_salary_slip(element, event);
