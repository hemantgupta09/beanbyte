...
var PB_FR_initiate = function () {
  ...
  const cardsTarget = function (element, event) {
    ...
    const _process_a = (data) => {
      ...
      switch (event.value) {
        ...
        case pb.fin.reconcile.initiate.a:
          return _process_a_inner_fun_a(element, event);

        case pb.fin.reconcile.initiate.b:
  ...
  const actionsTarget = function (element, _event) {
    ...
    switch (_event.value) {
      ...
      case pb.fin.reconcile.initiate:
