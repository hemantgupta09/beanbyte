...
var PB_FS_negative = function () {
  ...
  const cardsTarget = function (element, event) {
    ...
    const _process_a = (data) => {
      ...
      switch (event.value) {
        ...
        case pb.fin.statement.negative.a:
          return _process_a_inner_fun_a(element, event);

        case pb.fin.statement.negative.b:
  ...
  const actionsTarget = function (element, _event) {
    ...
    switch (_event.value) {
      ...
      case pb.fin.statement.negative:
