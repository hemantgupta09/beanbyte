...
var PB_FB_tformat = function () {
  ...
  const Sheet = (element, event) => {
    ...
    const sheetData = dummy_ajax_balances_fin.tformat([pb.fin.balance.tformat.p.sheet]);
  ...
  const Table = () => {
    ...
    const tableData = dummy_ajax_balances_fin.tformat([pb.fin.balance.tformat.p.trans]);
